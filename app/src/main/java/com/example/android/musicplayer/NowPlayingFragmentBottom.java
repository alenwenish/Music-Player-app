...
import static com.example.android.musicplayer.MainActivity.ARTIST_TO_FRAG;
import static com.example.android.musicplayer.MainActivity.PATH_TO_FRAG;
import static com.example.android.musicplayer.MainActivity.SHOW_MINI_PLAYER;
import static com.example.android.musicplayer.MainActivity.SONG_NAME_TO_FRAG;
                    ...
                    if (getActivity() != null) {
                        ...
                        if(SHOW_MINI_PLAYER)
                        {
                            if(PATH_TO_FRAG != null) {
                                ...
                                {
                                    Glide.with(getContext()).load(R.drawable.empty)
                                            .into(albumArt);
                                }
